...
return cljs.core.update.call(null,dependency,"requires",(function (p1__530_SHARP_){
return cljs.core.apply.call(null,cljs.core.dissoc,p1__530_SHARP_,cljs.core.keys.call(null,resolutions));
}));
});
npm_force_resolutions.core.map_vals = (function npm_force_resolutions$core$map_vals(f,m){
return cljs.core.apply.call(null,cljs.core.merge,cljs.core.map.call(null,(function (p__531){
var vec__532 = p__531;
...
return (function (p1__535_SHARP_){
return cljs.core.conj.call(null,p1__535_SHARP_,new_dependencies);
...
return npm_force_resolutions.core.map_vals.call(null,(function (p1__536_SHARP_,p2__537_SHARP_){
return npm_force_resolutions.core.patch_dependency.call(null,resolutions,p1__536_SHARP_,p2__537_SHARP_);
}),dependencies);
}));
});
...
return clojure.string.replace.call(null,clojure.string.replace.call(null,json_format.call(null,JSON.parse(json),(function (){var obj539 = {"type":"space","size":(2)};
return obj539;
})()),/\\\\\^/,"^"),/ +\n/,"");
});
npm_force_resolutions.core.main = (function npm_force_resolutions$core$main(var_args){
var args__4502__auto__ = [];
var len__4499__auto___541 = arguments.length;
var i__4500__auto___542 = (0);
while(true){
if((i__4500__auto___542 < len__4499__auto___541)){
args__4502__auto__.push((arguments[i__4500__auto___542]));

var G__543 = (i__4500__auto___542 + (1));
i__4500__auto___542 = G__543;
continue;
} else {
}
break;
...
/** @this {Function} */
npm_force_resolutions.core.main.cljs$lang$applyTo = (function (seq540){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq540));
});
