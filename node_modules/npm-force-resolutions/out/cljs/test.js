...
var G__1857 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__1857,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__1857;
}
});
...
var len__4499__auto___1862 = arguments.length;
var i__4500__auto___1863 = (0);
while(true){
if((i__4500__auto___1863 < len__4499__auto___1862)){
args__4502__auto__.push((arguments[i__4500__auto___1863]));

var G__1864 = (i__4500__auto___1863 + (1));
i__4500__auto___1863 = G__1864;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq1859){
var G__1860 = cljs.core.first.call(null,seq1859);
var seq1859__$1 = cljs.core.next.call(null,seq1859);
var G__1861 = cljs.core.first.call(null,seq1859__$1);
var seq1859__$2 = cljs.core.next.call(null,seq1859__$1);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__1860,G__1861,seq1859__$2);
});
...
var map__1866 = m;
var map__1866__$1 = ((((!((map__1866 == null)))?(((((map__1866.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1866.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__1866):map__1866);
var file = cljs.core.get.call(null,map__1866__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__1866__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__1866__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__1866,map__1866__$1,file,line,column){
return (function (p1__1865_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__1865_SHARP_));
});})(map__1866,map__1866__$1,file,line,column))
...
var temp__5457__auto___1868 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___1868)){
var message_1869 = temp__5457__auto___1868;
cljs.core.println.call(null,message_1869);
} else {
}
...
var temp__5457__auto___1870 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___1870)){
var message_1871 = temp__5457__auto___1870;
cljs.core.println.call(null,message_1871);
} else {
}
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__1872 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1872),"/"].join('');
} else {
return G__1872;
}
})();
...
var G__1874 = exception.stack;
var G__1874__$1 = (((G__1874 == null))?null:clojure.string.split_lines.call(null,G__1874));
var G__1874__$2 = (((G__1874__$1 == null))?null:cljs.core.get.call(null,G__1874__$1,depth));
if((G__1874__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__1874__$2);
}
} else {
...
var vec__1875 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__1875,(0),null);
var column = cljs.core.nth.call(null,vec__1875,(1),null);
var vec__1878 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__1878,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__1878,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__1878,(2),null);
...
var m__$1 = (function (){var G__1881 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__1885 = (function (){var G__1884 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__1884);
} else {
return G__1884;
}
})();
...
return cljs.core.vary_meta.call(null,G__1886,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__1890 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__1890,(0),null);
var types = vec__1890;
...
return cljs.core.map.call(null,(function (p__1893){
var vec__1894 = p__1893;
var ns = cljs.core.nth.call(null,vec__1894,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__1894,(1),null);
return ((function (vec__1894,ns,vars__$1){
return (function (){
...
var G__1897 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__1897__$1 = (((G__1897 instanceof cljs.core.Keyword))?G__1897.fqn:null);
switch (G__1897__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__1897,G__1897__$1,env,once_fixtures,each_fixtures,vec__1894,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__1897,G__1897__$1,env,once_fixtures,each_fixtures,vec__1894,ns,vars__$1){
return (function (){
var seq__1898 = cljs.core.seq.call(null,vars__$1);
var chunk__1899 = null;
var count__1900 = (0);
var i__1901 = (0);
while(true){
if((i__1901 < count__1900)){
var v = cljs.core._nth.call(null,chunk__1899,i__1901);
var temp__5457__auto___1903 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___1903)){
var t_1904 = temp__5457__auto___1903;
each_fixture_fn.call(null,((function (seq__1898,chunk__1899,count__1900,i__1901,t_1904,temp__5457__auto___1903,v,each_fixture_fn,G__1897,G__1897__$1,env,once_fixtures,each_fixtures,vec__1894,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_1904)));
});})(seq__1898,chunk__1899,count__1900,i__1901,t_1904,temp__5457__auto___1903,v,each_fixture_fn,G__1897,G__1897__$1,env,once_fixtures,each_fixtures,vec__1894,ns,vars__$1))
);
} else {
}


var G__1905 = seq__1898;
var G__1906 = chunk__1899;
var G__1907 = count__1900;
var G__1908 = (i__1901 + (1));
seq__1898 = G__1905;
chunk__1899 = G__1906;
count__1900 = G__1907;
i__1901 = G__1908;
...
var temp__5457__auto__ = cljs.core.seq.call(null,seq__1898);
if(temp__5457__auto__){
var seq__1898__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__1898__$1)){
var c__4319__auto__ = cljs.core.chunk_first.call(null,seq__1898__$1);
var G__1909 = cljs.core.chunk_rest.call(null,seq__1898__$1);
var G__1910 = c__4319__auto__;
var G__1911 = cljs.core.count.call(null,c__4319__auto__);
var G__1912 = (0);
seq__1898 = G__1909;
chunk__1899 = G__1910;
count__1900 = G__1911;
...
var v = cljs.core.first.call(null,seq__1898__$1);
var temp__5457__auto___1913__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___1913__$1)){
var t_1914 = temp__5457__auto___1913__$1;
each_fixture_fn.call(null,((function (seq__1898,chunk__1899,count__1900,i__1901,t_1914,temp__5457__auto___1913__$1,v,seq__1898__$1,temp__5457__auto__,each_fixture_fn,G__1897,G__1897__$1,env,once_fixtures,each_fixtures,vec__1894,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_1914)));
});})(seq__1898,chunk__1899,count__1900,i__1901,t_1914,temp__5457__auto___1913__$1,v,seq__1898__$1,temp__5457__auto__,each_fixture_fn,G__1897,G__1897__$1,env,once_fixtures,each_fixtures,vec__1894,ns,vars__$1))
);
} else {
}


var G__1915 = cljs.core.next.call(null,seq__1898__$1);
var G__1916 = null;
var G__1917 = (0);
var G__1918 = (0);
seq__1898 = G__1915;
...
});})(each_fixture_fn,G__1897,G__1897__$1,env,once_fixtures,each_fixtures,vec__1894,ns,vars__$1))
);
});})(each_fixture_fn,G__1897,G__1897__$1,env,once_fixtures,each_fixtures,vec__1894,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1897__$1)].join('')));

}
})());
});
;})(vec__1894,ns,vars__$1))
